      ...
      <div className="grid grid-cols-2">
    {
      ...
      <footer className="footer items-center p-4 text-neutral-content bg-cyan-950">
        <div className="items-center grid-flow-col justify-self-center md:justify-self-start">
          <p>
            ...
            <a
              ...
              href="https://www.facebook.com/aliashraf1233/"
            >
              Ali Ashraf
            </a>
          </p>
        ...
        <div className="grid-flow-col gap-4 md:place-self-center justify-self-center md:justify-self-end">
          <a target="_" href="https://www.twitter.com/">
            <svg
          ...
          <a target="_" href="https://www.youtube.com/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a target="_" href="https://www.facebook.com/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
