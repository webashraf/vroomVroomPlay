...
const ChampionStudents = () => {
  ...
  return (
    <div className='py-10 bg-[url("https://images.pexels.com/photos/4940934/pexels-photo-4940934.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")] hidden md:block'>
      <Swiper
        slidesPerView={3}
        spaceBetween={20}
        pagination={{
